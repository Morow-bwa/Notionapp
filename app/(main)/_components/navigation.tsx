  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          "relative z-[99999] flex h-full w-60 flex-col overflow-y-auto bg-secondary",
      ...
      >
        ...
        <div 
          ...
          onClick={resetWidth}
          className="opacity-0 group-hover:opacity-100 transition cursor-ew-resize absolute h-full w-1 bg-primary-100 right-0 top-0" 
        />
      </aside>
      <div
        ref={navbarRef}
